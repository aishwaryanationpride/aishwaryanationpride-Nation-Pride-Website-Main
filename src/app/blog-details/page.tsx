              ...
              <div>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    In today’s fast-paced digital world, the user experience is
                    everything. Whether you’re building a sleek startup website,
                    an advanced SaaS platform, or a modern business site, the
                    quality and usability of your UI components play a pivotal
                    role in ensuring a seamless experience for your visitors.
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    <strong className="text-primary dark:text-white">
                      Nation Pride IT Solution
                    </strong>
                    , we prioritize delivering cutting-edge UI solutions that
                    enhance both form and function. Let’s explore some of the
                    best UI components that are essential for building modern,
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    A good navigation bar is crucial for guiding users through
                    your website. Responsive navigation ensures that your menu
                    adapts to all screen sizes, providing a flawless experience
                  ...
                  <ul className="mb-10 list-inside list-disc text-body-color">
                    ...
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Essential for mobile-first designs.
                    </li>
                    <li className="mb-2 text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg">
                      Helps reduce bounce rates by improving usability.
                    </li>
                  </ul>
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      The hero section is the
                      first thing users see when they land on your site.
                      Featuring large, high-quality images or videos with
                      concise, impactful messaging can capture attention and set
                      the tone for the rest of the site.
                    </p>
